...
```
    ...
    <ipython-input-9-af0a30818717> in <module>
         19 
         20 # 3. Modular la cadena de bits usando el esquema BPSK
    ---> 21 senal_Tx, Pm, portadora, moduladora = modulador(bits_Tx, fc, mpp)
         22 
         23 # 4. Se transmite la señal modulada, por un canal ruidoso
    

    NameError: name 'modulador' is not defined
...
```
    ...
    <ipython-input-10-b91620b7649c> in <module>
          5 
          6 # La onda cuadrada moduladora (bits de entrada)
    ----> 7 ax1.plot(moduladora[0:600], color='r', lw=2)
          8 ax1.set_ylabel('$b(t)$')
          9 
    

    NameError: name 'moduladora' is not defined
...
```
    ...
    <ipython-input-11-39e80f231350> in <module>
          2 
    ...
    NameError: name 'senal_Tx' is not defined
...
```
    ...
    Duración de la simulación:  16.160985231399536
    6961 errores, para un BER de 0.0165.
