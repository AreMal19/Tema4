...
# ---
# 
# * Estudiante: **Christopher Fernández, Estefany Barboza, Arelys Malachany**
# * Carné: **B82951, B50853, B74407**
# * Grupo: **2,**
# 
# ---
...
def demodulador(senal_Rx, portadora, portadora2, mpp):
    ...
    for i in range(N):
        ...
        #tanta para la portadora 1 como la 2
...
en la gráfica la energía se mantiene constante por lo que el sistema es ergodico.'''
